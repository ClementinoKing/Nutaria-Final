  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav: "pointer-events-none absolute inset-x-0 top-0 flex items-center justify-between px-0.5",
        button_previous:
          "pointer-events-auto inline-flex h-7 w-7 items-center justify-center rounded-md border border-border bg-background text-muted-foreground shadow-sm transition-colors hover:border-olive/40 hover:bg-olive-light/20 hover:text-foreground",
        button_next:
          "pointer-events-auto inline-flex h-7 w-7 items-center justify-center rounded-md border border-border bg-background text-muted-foreground shadow-sm transition-colors hover:border-olive/40 hover:bg-olive-light/20 hover:text-foreground",
        dropdowns: "flex items-center justify-center gap-2 px-10",
        dropdown_root: "relative inline-flex items-center",
        dropdown:
          "h-8 appearance-none rounded-md border border-border bg-background px-3 text-sm font-semibold text-foreground shadow-sm outline-none transition-colors hover:border-olive/40 focus:border-olive/50 focus:ring-2 focus:ring-olive/20",
        months_dropdown: "min-w-[7.75rem] pr-8",
        years_dropdown: "min-w-[5.75rem] pr-8",
        chevron: "hidden",
