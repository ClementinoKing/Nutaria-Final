export interface SupplyQualityParameter {
  code: string
  name: string
...
export interface SupplyQualityScoreLegend {
  score: number
  meaning: string
}

export const SUPPLY_QUALITY_PARAMETERS: SupplyQualityParameter[] = [
  {
...
export const SUPPLY_QUALITY_SCORE_LEGEND: SupplyQualityScoreLegend[] = [
  {
    score: 3,
