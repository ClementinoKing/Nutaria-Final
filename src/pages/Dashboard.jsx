...
function Dashboard() {
  ...
  return (
    <PageLayout title="Dashboard" activeItem="dashboard" contentClassName="px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        <h2 className="mb-2 text-3xl font-bold text-text-dark">Welcome back, {displayName}!</h2>
          ...
          return (
            <Card key={index} className="bg-white border-olive-light/30">
              ...
              <CardContent>
                ...
                <CardDescription className="mt-1 text-xs text-text-dark/60">
                  {stat.description}
        ...
        <div className="mb-6 rounded-md border border-orange-200 bg-orange-50 p-4 text-sm text-orange-800">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <button
                type="button"
                className="mt-3 inline-flex items-center rounded-md border border-orange-200 px-3 py-1 text-xs font-medium text-orange-800 hover:bg-orange-100"
                onClick={refresh}
              >
                Retry loading data
              </button>
      ...
      <Card className="bg-white border-olive-light/30">
        ...
        <CardContent>
          <div className="divide-y divide-olive-light/20">
            {loading ? (
              <div className="py-6 text-sm text-text-dark/60">Loading recent inventory…</div>
            ) : recentStock.length === 0 ? (
              <div className="py-6 text-sm text-text-dark/60">
                ...
                return (
                  ...
                  >
                    <div>
                      ...
                      <p className="mt-1 text-xs text-text-dark/60">{stock.warehouse_name || 'Warehouse not set'}</p>
                    </div>
