...
import { FileText, MapPin, Truck, User2 } from 'lucide-react'
...
const hydrateShipment = (shipment) => {
  if (!shipment) {
    return null
  }
...
function ShipmentDetail() {
  ...
  const totalItems = shipment.items.reduce((count, item) => count + (item.quantity ?? 0), 0)
