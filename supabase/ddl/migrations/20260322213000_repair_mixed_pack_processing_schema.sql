...
ALTER TABLE public.mixed_pack_batches
  ADD COLUMN IF NOT EXISTS supply_id bigint NULL REFERENCES public.supplies(id) ON DELETE SET NULL,
  ADD COLUMN IF NOT EXISTS supply_batch_id bigint NULL REFERENCES public.supply_batches(id) ON DELETE SET NULL,
  ADD COLUMN IF NOT EXISTS process_id bigint NULL REFERENCES public.processes(id) ON DELETE SET NULL,
  ADD COLUMN IF NOT EXISTS process_step_id bigint NULL REFERENCES public.process_steps(id) ON DELETE SET NULL,
  ADD COLUMN IF NOT EXISTS process_lot_run_id bigint NULL REFERENCES public.process_lot_runs(id) ON DELETE SET NULL,
  ADD COLUMN IF NOT EXISTS process_step_run_id bigint NULL REFERENCES public.process_step_runs(id) ON DELETE SET NULL,
  ADD COLUMN IF NOT EXISTS packaging_run_id bigint NULL REFERENCES public.process_packaging_runs(id) ON DELETE SET NULL,
  ADD COLUMN IF NOT EXISTS pack_entry_id bigint NULL REFERENCES public.process_packaging_pack_entries(id) ON DELETE SET NULL,
  ADD COLUMN IF NOT EXISTS storage_allocation_id bigint NULL REFERENCES public.process_packaging_storage_allocations(id) ON DELETE SET NULL;
